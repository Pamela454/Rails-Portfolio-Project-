...
User.create!(email: 'ddave@gmail.com', name: 'Dave', npi: 12345678910, specialty: 'Family Medicine', type: 'Physician', password: 'Dave@123')
User.create(email: 'ssarah@gmail.com', name: 'Sara', npi: 12345678911, specialty: 'Anesthesia', type: 'Physician', password: 'Sarah@123')
...
MessageCategory.create!(message_id: '1', category_id: '1', category_id: '4')
